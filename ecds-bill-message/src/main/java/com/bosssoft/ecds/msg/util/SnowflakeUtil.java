...
public class SnowflakeUtil {
    ...
    static class SnowflakeUtilException extends RuntimeException{

        public SnowflakeUtilException(String message) {
            super(message);
        }
    }
    ...
    public static synchronized long genId(){
        ...
        if (now < lastTimeStamp) {
            throw new SnowflakeUtilException(String.format("系统时间错误！ %d 毫秒内拒绝生成雪花ID！", START_TIME - now));
        }
