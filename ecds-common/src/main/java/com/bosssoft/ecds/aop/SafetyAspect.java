...
public class SafetyAspect {
     ...
     */
    @Pointcut("@within(com.bosssoft.ecds.encryption.Encrypt) || @annotation(com.bosssoft.ecds.encryption.Encrypt) || " +
            "@within(com.bosssoft.ecds.encryption.Decrypt) || @annotation(com.bosssoft.ecds.encryption.Decrypt)")
    ...
    public Object around(ProceedingJoinPoint pjp) {
        try {
            ...
            if (hasEncrypt) {
                ...
                o = new QueryResponseResult(CommonCode.SUCCESS, mapper.readValue("{\"data\":\"" + data + "\",\"aesKey\":\"" + aesKey + "\"}", Object.class));
            }
...
//            log.error(ErrorUtil.errorInfoToString(e));
            return new QueryResponseResult(CommonCode.FAIL, e.getMessage());
        }
    }
}
