...
public class UserController {
    ...
    public String save(@RequestBody UserVO userVO) {
        // 转换为DTO
        UserDTO userDTO = BeanUtils.copyProperties(userVO, UserDTO.class);
        ...
        // 转换为VO
        userVO = BeanUtils.copyProperties(userDTO, UserVO.class);
        roleDTOList = userDTO.getRoles();
        roleVOList = BeanUtils.copyListProperties(roleDTOList, RoleVO.class);
    ...
    public String removeBatch(@RequestBody List<UserVO> userVOList) {
        List<UserDTO> userDTOList = BeanUtils.copyListProperties(userVOList, UserDTO::new);
