...
public class ResponseUtils {
    ...
    public static String getResponse(Object content, ResultType code) {
        ResponseBody outputParam = new ResponseBody();
    ...
    public enum ResultType {
         ...
         */
        SWITCHING_PROTOCOLS(true, 101, "Switching Protocols"),
         ...
         */
        PROCESSING(true, 102, "Processing"),
         ...
         */
        CHECKPOINT(true, 103, "Checkpoint"),
         ...
         */
        NON_AUTHORITATIVE_INFORMATION(true, 203, "Non-Authoritative Information"),
         ...
         */
        RESET_CONTENT(true, 205, "Reset Content"),
         ...
         */
        PARTIAL_CONTENT(true, 206, "Partial Content"),
         ...
         */
        MULTI_STATUS(true, 207, "Multi-Status"),
         ...
         */
        ALREADY_REPORTED(true, 208, "Already Reported"),
         ...
         */
        MULTIPLE_CHOICES(true, 300, "Multiple Choices"),
         ...
         */
        MOVED_PERMANENTLY(true, 301, "Moved Permanently"),
         ...
         */
        MOVED_TEMPORARILY(true, 302, "Moved Temporarily"),
         ...
         */
        NOT_MODIFIED(true, 304, "Not Modified"),
         ...
         */
        TEMPORARY_REDIRECT(true, 307, "Temporary Redirect"),
         ...
         */
        PERMANENT_REDIRECT(true, 308, "Permanent Redirect"),
         ...
         */
        BAD_REQUEST(true, 400, "Bad Request"),
         ...
         */
        PAYMENT_REQUIRED(true, 402, "Payment Required"),
         ...
         */
        METHOD_NOT_ALLOWED(true, 405, "Method Not Allowed"),
         ...
         */
        NOT_ACCEPTABLE(true, 406, "Not Acceptable"),
         ...
         */
        PROXY_AUTHENTICATION_REQUIRED(true, 407, "Proxy Authentication Required"),
         ...
         */
        REQUEST_TIMEOUT(true, 408, "Request Timeout"),
         ...
         */
        LENGTH_REQUIRED(true, 411, "Length Required"),
         ...
         */
        PRECONDITION_FAILED(true, 412, "Precondition Failed"),
         ...
         * @since 4.1
         */
        PAYLOAD_TOO_LARGE(true, 413, "Payload Too Large"),
         ...
         */
        REQUEST_ENTITY_TOO_LARGE(true, 413, "Request Entity Too Large"),
         ...
         * @since 4.1
         */
        URI_TOO_LONG(true, 414, "URI Too Long"),
         ...
         */
        REQUEST_URI_TOO_LONG(true, 414, "Request-URI Too Long"),
         ...
         */
        UNSUPPORTED_MEDIA_TYPE(true, 415, "Unsupported Media Type"),
         ...
         */
        REQUESTED_RANGE_NOT_SATISFIABLE(true, 416, "Requested range not satisfiable"),
         ...
         */
        EXPECTATION_FAILED(true, 417, "Expectation Failed"),
         ...
         */
        I_AM_A_TEAPOT(true, 418, "I'm a teapot"),
         ...
         */
        INSUFFICIENT_SPACE_ON_RESOURCE(true, 419, "Insufficient Space On Resource"),
         ...
         */
        UNPROCESSABLE_ENTITY(true, 422, "Unprocessable Entity"),
         ...
         */
        FAILED_DEPENDENCY(true, 424, "Failed Dependency"),
         ...
         */
        UPGRADE_REQUIRED(true, 426, "Upgrade Required"),
         ...
         */
        PRECONDITION_REQUIRED(true, 428, "Precondition Required"),
         ...
         */
        TOO_MANY_REQUESTS(true, 429, "Too Many Requests"),
         ...
         */
        REQUEST_HEADER_FIELDS_TOO_LARGE(true, 431, "Request Header Fields Too Large"),
         ...
         * @since 4.3
         */
        UNAVAILABLE_FOR_LEGAL_REASONS(true, 451, "Unavailable For Legal Reasons"),
         ...
         */
        NOT_IMPLEMENTED(true, 501, "Not Implemented"),
         ...
         */
        BAD_GATEWAY(true, 502, "Bad Gateway"),
         ...
         */
        SERVICE_UNAVAILABLE(true, 503, "Service Unavailable"),
         ...
         */
        GATEWAY_TIMEOUT(true, 504, "Gateway Timeout"),
         ...
         */
        HTTP_VERSION_NOT_SUPPORTED(true, 505, "HTTP Version not supported"),
         ...
         */
        VARIANT_ALSO_NEGOTIATES(true, 506, "Variant Also Negotiates"),
         ...
         */
        INSUFFICIENT_STORAGE(true, 507, "Insufficient Storage"),
         ...
         */
        LOOP_DETECTED(true, 508, "Loop Detected"),

        /**
         * {@code 509 Bandwidth Limit Exceeded}
         */
        BANDWIDTH_LIMIT_EXCEEDED(true, 509, "Bandwidth Limit Exceeded"),
         ...
         */
        NOT_EXTENDED(true, 510, "Not Extended"),
         ...
         */
        NETWORK_AUTHENTICATION_REQUIRED(true, 511, "Network Authentication Required");

        private final Integer code;

        private final String msg;

        ResultType(boolean b, Integer code, String msg) {
            this.code = code;
            this.msg = msg;
        }
