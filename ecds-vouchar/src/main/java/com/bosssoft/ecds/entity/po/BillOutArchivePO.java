...
public class BillOutArchivePO extends Model<BillOutArchivePO> {
    ...
    public static final String F_BILL_BATCH = "f_bill_batch";

    public static final String F_BILL_TYPE = "f_bill_type";
