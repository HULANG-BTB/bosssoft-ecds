...
public class PermissionServiceImpl extends ServiceImpl<PermissionDao, PermissionPO> implements PermissionService {
    ...
    public List<PermissionDTO> getByRid(PermissionDTO entity) {
        ...
        List<PermissionDTO> permissionDTOList = BeanUtils.copyListProperties(byRid, PermissionDTO.class);
    ...
    public List<PermissionDTO> listAll() {
        ...
        // 转换数据
        List<PermissionDTO> permissionDTOList = BeanUtils.copyListProperties(permissionPOList, PermissionDTO.class);
        return permissionDTOList;
    }
    ...
    public PageDTO listByPage(PageDTO pageDTO) {
        ...
        // 数据转换
        List<PermissionDTO> permissionDTOList = BeanUtils.copyListProperties(records, PermissionDTO.class);
    ...
    public List<PermissionDTO> listByTree() {
        ...
        List<PermissionDTO> permissionDTOList = BeanUtils.copyListProperties(permissions, PermissionDTO::new);
        return permissionDTOList;
    }
