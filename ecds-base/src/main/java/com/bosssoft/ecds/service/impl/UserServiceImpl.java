...
public class UserServiceImpl extends ServiceImpl<UserDao, UserPO> implements UserService {
    ...
    public UserDTO save(UserDTO userDTO) {
        ...
        List<RolePO> rolePOList = BeanUtils.copyListProperties(userDTO.getRoles(), RolePO.class);
        // 插入用户信息
        boolean userSaveResult = super.save(userPO);
        // 转换为DTO
        userDTO = BeanUtils.copyProperties(userPO, UserDTO.class);
        if (userSaveResult) {
    ...
    public Boolean remove(UserDTO entity) {
        UserPO userPO = BeanUtils.copyProperties(entity, UserPO.class);
    ...
    public Boolean update(UserDTO userDTO) {
        ...
        // 读取角色列表
        List<RolePO> newRoleList = BeanUtils.copyListProperties(userDTO.getRoles(), RolePO.class);
    ...
    public PageDTO listByPage(PageDTO pageDTO) {
        ...
        // 转换数据
        List<UserDTO> userDTOList = BeanUtils.copyListProperties(records, UserDTO::new);
