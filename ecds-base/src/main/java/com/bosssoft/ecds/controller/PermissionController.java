...
public class PermissionController {
    ...
    public String getByRid(@PathVariable("id") Long id) {
        ...
        PermissionDTO permissionDTO = BeanUtils.copyProperties(permissionVO, PermissionDTO.class);

        List<PermissionDTO> permissionDTOList = permissionService.getByRid(permissionDTO);
        List<PermissionVO> permissionVOList = BeanUtils.copyListProperties(permissionDTOList, PermissionVO.class);
    ...
    public String getTreeList() {
        ...
        List<PermissionVO> permissionVOList = BeanUtils.copyListProperties(treeList, PermissionVO::new);
        return ResponseUtils.getResponse(permissionVOList, ResponseUtils.ResultType.OK);
    }
