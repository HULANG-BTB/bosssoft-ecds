...
public enum CbillAccountingCode implements ResultCode {
    ...
    PAYER_TEL_NOT_EXIST(false,1005,"该缴款人电话不存在"),
    ...
    BILL_NO_ILLEGAL(false, 1010, "票据号码不合理"),
    BILL_BATCH_ID_NOT_EXIST(false, 1011, "票据批次号不存在"),
    TIME_ILLEGAL(false, 1012, "开票时间必须在入账时间之后"),
    ;
